...
const SkillDevelopment = dynamic(
  () => import("@/Components/Home/SkillDevelopment"),
  { ssr: false }
);
const SkillYourWay = dynamic(() => import("@/Components/Home/SkillYourWay"), {
  ssr: false,
});
const WorldsFirstAI = dynamic(() => import("@/Components/Home/WorldsFirstAI"), {
  ssr: false,
});
const Achievement = dynamic(
  () => import("@/Components/achivepages/achievements/Achievement"),
  { ssr: false }
);
const CertificateAchievement = dynamic(
  () =>
    import(
      "@/Components/achivepages/certificate-achivement/CertificateAchievement"
    ),
  { ssr: false }
);
const MentorsTrainer = dynamic(
  () =>
    import("@/Components/achivepages/mentors-trainers-review/MentorsTrainer"),
  { ssr: false }
);
const PopularCourses = dynamic(
  () => import("@/Components/achivepages/popular-courses/PopularCourses"),
  { ssr: false }
);
const Project_planning = dynamic(
  () => import("@/Components/achivepages/project-planning/Project_planning"),
  { ssr: false }
);
