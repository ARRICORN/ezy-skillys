        ...
        <div className="w-full px-6 relative">
            <div className="w-full lg:w-10/12 mx-auto my-8 px-5 relative">
                ...
                <div>
                    ...
                    <h1 className="text-[#003F7D] text-5xl pb-5 font-extrabold text-center">Choose The <span className="text-[#f98149]">Course</span></h1>
                    {/* main section */}
                            ...
                            <div className='col-span-8 md:col-span-5 relative'>
                                ...
                                <div>
                                    ...
                                    <div className='flex justify-center gap-2 lg:gap-7  ml-5 lg:ml-24 pt-5 '>
                                        <div>
                                            ...
                                            <button onClick={lookingJobClicked} className={`border-2 bg-white  border-white  p-5 rounded-3xl`}>
                                        ...
                                        <div>
                                            <button onClick={upSkill} className="border-2 border-white p-5 rounded-3xl">
                                ...
                                </div>
                                {
                                    isLookingJob && <>
                                                ...
                                                <div className='flex  relative ' >
                                                    ...
                                                    <div className=' w-full md:w-[470px] ml-5 md:ml-0'>
                                                        ...
                                                        <div className='flex  justify-between md:justify-start '>
                                                            <button onClick={() => setIsDiscoverCourse(true)} className='px-3 md:px-8 mt-4 py-4 rounded-lg text-white bg-[#f98149]'>Discover Course</button>
                                                ...
                                                <div>
                                                    <div>
                                                        ...
                                                        <div className='w-full flex px-3 md:px-0'>
                                                            <button onClick={() => setIsItField(true)} className='px-4  md:px-16 mt-4 py-4 rounded-lg text-white bg-[#f98149]'>IT Field</button>
                                        ...
                                        <div className={`${isItField ? "block" : "hidden"}`} >
                                            <div className='mt-7 relative'>
                                                ...
                                                <div className='flex justify-start ml-3 md:ml-32 gap-8 py-5'>
                                                    ...
                                                    <div>
                                                        <button onClick={() => setIsCoding(true)} className="border-2 bg-white border-white p-5 rounded-3xl">
                                            ...
                                            <div className="flex gap-9 flex-col md:flex-row mt-3  items-center relative">
                                                ...
                                                <div className=''>
                                                    ...
                                                    <div className='flex justify-start ml-2 gap-5 md:gap-11 pt-5 '>
                                                        <div>
                                                            <button onClick={() => setChoosedPath({ status: true, course: "front-end" })} className="border-2 border-white bg-white p-5 rounded-3xl">
                                        ...
                                        {/* click next to part */}
                                        <div className={`${choosedPath.status ? "block" : "hidden"}`}>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div >
                                                            ...
                                                            <Link href="/ItCourses/categories=it&categories=coding&categories=forntend">
                                                                <button className='px-6 mt-4 py-2 rounded-lg text-white bg-[#f98149]'>Next</button>
                                                            </Link>
