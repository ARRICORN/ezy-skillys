          ...
          <div className="space-y-8 mt-1">
            ...
            <div>
              <div className="flex items-center justify-between">
                <h3 className="mb-3 text-lg font-bold md:text-xl">Address</h3>
              ...
              <ul className="space-y-4">
                <li className="space-y-1">
                  ...
                  <p className="ml-7 dark:text-gray-600">Bangladesh</p>
                </li>
                <li className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <svg
                  ...
                  <p className="ml-7 dark:text-gray-600">Habiganj</p>
                </li>
                <li className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <svg
                  ...
                  <p className="ml-7 dark:text-gray-600">Habigonj Sadar</p>
                </li>
                <li className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <svg
                  ...
                  <p className="ml-7 dark:text-gray-600"></p>
                </li>
              </ul>
            </div>
            {/* === Education === */}
              ...
              <ul className="space-y-4">
                <li className="space-y-1">
                  <div className="flex items-center space-x-2">
                    ...
                    <h4 className="font-medium">Your Education level</h4>
                  </div>
                  <p className="ml-7 dark:text-gray-600">JSC/JDC/8 Pass</p>
                </li>
                <li className="space-y-1">
                  <div className="flex items-center space-x-2">
                    <svg
                ...
                <li className="space-y-1">
                  <div className="flex items-center space-x-2">
                    ...
                    <h4 className="font-medium">Are you a CSE/CS student?</h4>
                  </div>
                  <p className="ml-7 dark:text-gray-600">No</p>
                </li>
              </ul>
            </div>
          </div>
